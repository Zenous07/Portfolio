    ...
    <div className="flex flex-col flex-1 min-h-screen bg-white p-4 font-inter">
      ...
      <main className="relative flex-1 w-full bg-[#050505] rounded-[40px] overflow-hidden shadow-2xl">
        ...
        <div className="absolute top-0 left-0 bg-white rounded-br-[40px] p-6 pr-8 pb-8 z-20">
          ...
          {/* Logo Pill */}
          <div className="bg-[#050505] text-white rounded-[24px] px-8 py-3 font-orbitron font-bold text-2xl tracking-widest italic flex items-center justify-center cursor-pointer hover:bg-black transition-all transform hover:scale-105">
            LOGO
          </div>
        </div>
        ...
        <div className="absolute top-0 right-0 bg-white rounded-bl-[40px] p-6 pl-8 pb-8 flex items-center gap-4 z-20">
          ...
          {/* Search Button */}
          <button className="w-14 h-14 bg-[#050505] rounded-full flex items-center justify-center hover:bg-black transition-all transform hover:scale-105 cursor-pointer">
          ...
          {/* Contact Pill */}
          <button className="h-14 px-8 bg-[#050505] rounded-[28px] flex items-center justify-center gap-3 hover:bg-black transition-all transform hover:scale-105 cursor-pointer">
