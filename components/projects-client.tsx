...
export default function ProjectsClient({ repos }: { repos: any[] }) {
  ...
  // Helper to convert hex to HSL string for BorderGlow
            ...
            repos.map((repo: any) => (
              ...
              >
                <BorderGlow 
                  ...
                  glowColor={hexToHslString(accentColor)}
                  backgroundColor="#050505"
                  colors={[accentColor, '#555555', '#222222']}
                  animated={true}
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center gap-6 text-sm text-[#555555] mt-auto font-inter border-t border-white/5 pt-4">
                      <span className="flex items-center gap-2">
                        <span className="w-3 h-3 rounded-full bg-[var(--accent)] inline-block"></span>
                        {repo.language || 'Code'}
                      </span>
