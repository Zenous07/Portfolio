...
export default function Contact() {
  return (
    <section className="w-full relative bg-[#050505] text-white flex flex-col pt-24 pb-8 px-6 md:px-12 lg:px-24 overflow-hidden font-inter z-10">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20 flex justify-evenly -z-10">
        <div className="w-[1px] h-full bg-gradient-to-b from-transparent via-[#d49353] to-transparent"></div>
        <div className="w-[1px] h-full bg-gradient-to-b from-transparent via-[#d49353] to-transparent"></div>
        <div className="w-[1px] h-full bg-gradient-to-b from-transparent via-[#d49353] to-transparent"></div>
        <div className="w-[1px] h-full bg-gradient-to-b from-transparent via-[#d49353] to-transparent"></div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full mb-16 md:mb-24 gap-8">
        ...
        <div className="flex items-center gap-1 group cursor-pointer active:scale-[0.97] transition-transform duration-[160ms] ease-[var(--ease-ui)]">
          <button className="bg-[#d49353] text-[#050505] font-orbitron font-bold text-xs md:text-sm tracking-widest uppercase px-6 md:px-8 py-4 pointer-events-none">
            Book A Demo
          </button>
          <button className="bg-[#d49353] text-[#050505] px-4 py-4 flex items-center justify-center pointer-events-none">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-start w-full mb-16 md:mb-24 overflow-hidden">
        ...
        <div className="flex gap-2 md:gap-4 mr-4 md:mr-8 h-[12vw] min-h-[80px]">
          <div className="w-[4vw] min-w-[20px] h-full bg-[#d49353] transform -skew-x-[20deg]"></div>
          <div className="w-[4vw] min-w-[20px] h-full bg-[#d49353] transform -skew-x-[20deg]"></div>
          <div className="w-[4vw] min-w-[20px] h-full bg-[#d49353] transform -skew-x-[20deg]"></div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-24 w-full">
        ...
        <div className="flex items-start justify-start lg:justify-center">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-[#333333] flex items-center justify-center relative overflow-hidden group cursor-pointer hover:border-[#d49353] transition-colors">
            <div className="absolute inset-0 bg-[#d49353]/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex w-full h-12 border border-[#333333] focus-within:border-[#d49353] transition-colors overflow-hidden">
            <input 
              type="email" 
              placeholder="Enter your email" 
              className="bg-transparent flex-1 px-4 outline-none text-sm text-white placeholder-[#555555]"
            />
            <button className="bg-white text-black font-orbitron font-bold text-[10px] md:text-xs uppercase px-4 md:px-6 hover:bg-[#d49353] hover:text-black transition-colors">
              Submit
            </button>
          </div>
        </div>
