  ...
  return (
    <div id="home" className="flex flex-col flex-1 min-h-screen bg-white p-2 md:p-4 font-inter">
      ...
      <main className="relative flex-1 w-full bg-[#050505] rounded-[24px] md:rounded-[40px] overflow-hidden shadow-2xl">
        ...
        <video
          ref={videoRef}
          src={getAssetUrl("animation2.mp4")}
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="absolute top-0 right-0 bg-white rounded-bl-[16px] md:rounded-bl-[40px] p-2 pl-4 md:p-6 md:pl-8 md:pb-8 flex items-center gap-1.5 md:gap-4 z-20">
          ...
          {/* GitHub Link */}
          <a href="https://github.com/Zenous07" target="_blank" rel="noopener noreferrer" className="relative z-10 w-8 h-8 md:w-14 md:h-14 bg-[#050505] rounded-full flex items-center justify-center cursor-pointer active:scale-[0.97] transition-all duration-300 ease-[var(--ease-ui)] hover:shadow-[0_0_15px_var(--accent)] border border-transparent hover:border-accent group">
            <svg className="w-4 h-4 md:w-6 md:h-6 text-white group-hover:text-[var(--accent)] transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* LinkedIn Link */}
          <a href="https://www.linkedin.com/in/bennettjoshuaa" target="_blank" rel="noopener noreferrer" className="relative z-10 w-8 h-8 md:w-14 md:h-14 bg-[#050505] rounded-full flex items-center justify-center cursor-pointer active:scale-[0.97] transition-all duration-300 ease-[var(--ease-ui)] hover:shadow-[0_0_15px_var(--accent)] border border-transparent hover:border-accent group">
            <svg className="w-4 h-4 md:w-6 md:h-6 text-white group-hover:text-[var(--accent)] transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Resume Pill */}
          <a href={getAssetUrl("resume.pdf")} target="_blank" rel="noopener noreferrer" className="relative z-10 h-8 md:h-14 px-3 md:px-8 bg-[#050505] rounded-[16px] md:rounded-[28px] flex items-center justify-center cursor-pointer active:scale-[0.97] transition-all duration-300 ease-[var(--ease-ui)] hover:shadow-[0_0_15px_var(--accent)] border border-transparent hover:border-accent">
